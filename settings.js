...
module.exports = {
  // ===== BOT CORE SETTINGS =====
  SESSION_ID: process.env.SESSION_ID || "malvin~ZusSwSTZ#ODMN3aEhhyB7ZeIqHM_MgE5hnUkPYjcamC1PK2oqTwg", // Your bot's session ID (keep secure)
...
// add alive msg here 
  ...
  // ===== MEDIA & AUTOMATION =====
  FAKE_RECORDING: process.env.FAKE_RECORDING || "true", // Auto-record voice notes
